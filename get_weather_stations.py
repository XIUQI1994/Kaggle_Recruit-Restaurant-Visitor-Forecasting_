...
get the station within 20kms which has high 
coverage of rain and temp data for each restaurant
...
#find stations within 20km which has rain and temp coverage over 95% and 98%
n = 0
